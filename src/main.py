...
with st.container():
    ...
    st.write(
        "Con esta app podrás analizar el mercado de componentes electrónicos de ordenadores y portatiles, tomando como fuente principal de datos la tienda en línea PC Componentes. El objetivo de esta herramienta es que permita tanto a usuarios generales como a clientes especializados explorar y comprender mejor este mercado, por lo tanto la aplicación se dividirá en dos secciones: una para usuarios generales y otra para clientes especializados."
    )
    st.write(
        """
